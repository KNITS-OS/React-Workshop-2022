...
import { selectAllGroupsDataAsSelectOptions, selectVendorById, updateVendor } from "redux/features";
...
export const VendorsDetailsPage = () => {
  ...
  const vendors = useSelector(selectVendorById(vendorsId));
  ...
  const onSaveVendors = async updatedVendors => {
    dispatch(updateVendor({ id: vendorsId, body: updatedVendors }));
