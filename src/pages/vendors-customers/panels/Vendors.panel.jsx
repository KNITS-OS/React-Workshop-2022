...
// export const VendorsPanel = ({ vendors, groupOptions, roleOptions, onSave }) => {
//   const [onboardingDate, setOnboardingDate] = useState(
//     moment(vendors?.onboardingDate, DATE_FILTER_FORMAT)
//   );

//   const [offboardingDate, setOffboardingDate] = useState(
//     moment(vendors?.offboardingDate, DATE_FILTER_FORMAT)
//   );

//   const vendorsRole = selectRoleByIdAsSelectOption(vendors.roleId);
//   const vendorsGroups = selectGroupsByIdsAsSelectValues(vendors.groups || []);

//   const [roleId, setRoleId] = useState(vendors.roleId);
//   const [groups, setGroups] = useState(vendors.groups || []);

//   // state to know which group fields has the user selected
//   const [currentGroupSelections, setCurrentGroupSelections] = useState([]);

//   const onSaveVendors = () => {
//     const vendorsSaveRequest = {
//       id: vendors.id,
...
//     onSave(vendorsSaveRequest);
//   };
//   return (
//     <Form>
//       <h6 className="heading-small text-muted mb-4">Vendors Information</h6>
...
//       </div>
//       <hr className="my-4" />
//       <h6 className="heading-small text-muted mb-4">Vendors Data</h6>
//       <div className="pl-lg-4">
//         <Row>
//           <Col lg="4">
//             <InputField
...
//         </Row>
//         <Row>
//           <Button color="primary" type="button" onClick={onSaveVendors}>
//             Update Vendors
//           </Button>
//         </Row>
//       </div>
