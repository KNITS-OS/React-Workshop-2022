...
// export const CustomersPanel = ({ customers, groupOptions, roleOptions, onSave }) => {
...
//   const customersRole = selectRoleByIdAsSelectOption(customers.roleId);
//   const customersGroups = selectGroupsByIdsAsSelectValues(customers.groups || []);

//   const [roleId, setRoleId] = useState(customers.roleId);
